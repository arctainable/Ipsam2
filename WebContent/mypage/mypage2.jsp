					...
					<div class="container2-2-1" style="	text-align:center;">
						<nav>
						  ...
						  <c:set var="num" value="${count-((pagemaker.cri.pageNum-1)*3)}"/>
							<li class="#"><a href="mypage2.do?pageNum=${pagemaker.startPage}&amount=3" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>

						  <c:forEach var="num" begin="${pagemaker.startPage}" end="${pagemaker.endPage}">
							<li class=""><a href="mypage2.do?pageNum=${num}&amount=3">
							<c:choose>
							<c:when test="${num == 0}">
							1
							</c:when>
							...
							<li>
							  <a href="mypage2.do?pageNum=${pagemaker.endPage}&amount=3" aria-label="Next">
