...
<section>
			<div class="container2">
				...
				<div class="container2-2">
					...
					<div class="container2-2-1">
						<a href="myproject.do">
							<div class="container2-2-1-5 container-hover">
						...
						<a href="myproject3.do">
							<div class="container2-2-1-3" style="border-right: 0px;">
						...
						<c:forEach var="list" items="${list}">
							<div class="container2-2-2">
								...
								<div class="container2-2-2-6">
									<a href="sponsorlist.do?pno=${list.pno}&pname2=${list.pname2}"><button style="background: #3aa3e3; color:white;">후원자 확인</button></a> <button style="display:none;">배송현황</button> <button style="display:none;">후원자 확인</button>
								</div>
							</div>
						</c:forEach>
						</c:when>
					...
					<div class="container2-2-1" style="	text-align:center; border-top:1px solid #dbdbdb;">
						<nav>
						  ...
						  <c:set var="num" value="${count-((pagemaker.cri.pageNum-1)*3)}"/>
							<li class="#"><a href="myproject3.do?pageNum=${pagemaker.startPage}&amount=3" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>

						  <c:forEach var="num" begin="${pagemaker.startPage}" end="${pagemaker.endPage}">
							<li class=""><a href="myproject3.do?pageNum=${num}&amount=3">
							<c:choose>
							<c:when test="${num == 0}">
							1
							</c:when>
							...
							<li>
							  <a href="myproject3.do?pageNum=${pagemaker.endPage}&amount=3" aria-label="Next">
